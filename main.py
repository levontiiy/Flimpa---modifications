...
def _report_missing_and_exit(missing):
    ...
    installer = (
        "offline\\install_offline_windows.bat"
        if is_windows
        else "bash offline/install_offline_macos.command"
    )
    lines = [
        "",
        "============================================================",
    ...
    lines += [
        ...
        f"     {installer}",
        "",
        " Then ALWAYS start FLIMPA with that environment's Python:",
        "",
        f"     {py_cmd} main.py",
        "",
        ...
        "",
        " Tip: a missing library almost always means FLIMPA was launched",
        " with a different Python than the one where the libraries were",
        " installed. Use the .venv Python shown above.",
        "============================================================",
        "",
    ]
    sys.stderr.write("\n".join(lines) + "\n")
